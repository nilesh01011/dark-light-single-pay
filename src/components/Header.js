...
export default function Header() {
  ...
  // useEffect sidebars in Mobile views
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('scroll', () => {
      if (headerRef.current && window.scrollY > 100) {
        ...
        headerRef.current.style.borderBottomRightRadius = '2.5rem';
        headerRef.current.style.borderBottomLeftRadius = '2.5rem';
        headerRef.current.style.transition =
          'all 0.3s cubic-bezier(0.46, 0.03, 0.52, 0.96)';
      } else {
        headerRef.current.style.boxShadow = 'none';
        headerRef.current.style.borderBottomRightRadius = '0';
        headerRef.current.style.borderBottomLeftRadius = '0';
        headerRef.current.style.transition =
          'all 0.3s cubic-bezier(0.46, 0.03, 0.52, 0.96)';
      }
    });
